...
public class TempOrderService {
    ...
    public Observable<TempOrderBillWithState> getTempOrderBiillsList() {
        return Observable.create(new ObservableOnSubscribe<TempOrderBillWithState>() {
            @Override
            public void subscribe(ObservableEmitter<TempOrderBillWithState> emitter) throws Exception {
